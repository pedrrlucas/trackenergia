      ...
      <div className="grid gap-10 lg:grid-cols-[380px_minmax(0,1fr)] xl:grid-cols-[420px_minmax(0,1fr)] lg:gap-14 items-center">
        ...
        >
          <div className="overflow-visible" ref={emblaRef}>
            <div className="flex touch-pan-y gap-4 sm:gap-6 py-4 px-2" style={{ backfaceVisibility: 'hidden' }}>
              {items.map((t, index) => (
                <div
                  key={\`testimonial-slide-\${t.id}\`}
                  className="relative shrink-0 w-[85%] sm:w-[320px] lg:w-[340px] h-full"
                >
          ...
          <div className="mt-6 flex items-center gap-2 pl-2">
            <button
              onClick={scrollPrev}
              className="pointer-events-auto grid h-10 w-10 place-items-center rounded-full bg-white shadow-sm ring-1 ring-zinc-200 text-zinc-600 transition hover:bg-zinc-50 hover:text-zinc-900 active:scale-[0.98] z-20"
              aria-label="Anterior"
            >
