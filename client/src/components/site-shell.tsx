...
export function SiteFooter({ onContact }: { onContact: () => void }) {
  ...
  return (
    <footer id="footer" className="w-full bg-[#0a0014] relative border-t border-white/5 overflow-hidden rounded-t-[16px] lg:rounded-t-[24px] mt-4 lg:mt-8">
      ...
      <div className="mx-auto w-full max-w-[1560px] px-6 sm:px-8 lg:px-10 2xl:px-12 relative z-10">
        <div className="flex flex-col gap-12 py-16 lg:grid lg:grid-cols-12 lg:items-start lg:gap-8 lg:py-24">
