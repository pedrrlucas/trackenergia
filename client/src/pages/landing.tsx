    ...
    <div className="pointer-events-none absolute left-0 right-0 top-0 z-20">
      <div className="container-page pointer-events-auto">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0.06) 35%, rgba(29,2,56,0.14) 70%, rgba(255,255,255,0.12) 100%)",
          }}
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(255,255,255,0.30) 0%, rgba(255,255,255,0.10) 22%, rgba(255,255,255,0.04) 50%, rgba(255,255,255,0.10) 78%, rgba(255,255,255,0.30) 100%)",
              opacity: 0.85,
              zIndex: 0,
            }}
          />
          <div
            ...
            style={{
              background:
                "radial-gradient(120% 120% at 50% 0%, rgba(255,255,255,0.16) 0%, rgba(255,255,255,0) 58%), radial-gradient(120% 160% at 50% 120%, rgba(29,2,56,0.20) 0%, rgba(29,2,56,0) 55%)",
              zIndex: 0,
            }}
          />
          ...
          <button
            ...
            onClick={onContact}
            className="group relative inline-flex items-center gap-2 rounded-full bg-white/12 px-4 py-2 text-xs font-semibold text-white ring-1 ring-white/22 backdrop-blur transition hover:bg-white/16 active:scale-[0.98]"
          >
            <span className="relative">
              <span className="absolute -inset-x-2 -inset-y-1 rounded-full bg-white/20 opacity-0 blur-md transition-opacity duration-300 group-hover:opacity-100" />
              <span className="relative">Fale Conosco</span>
            </span>
            <span className="grid h-7 w-7 place-items-center rounded-full bg-white/10 ring-1 ring-white/14 transition duration-300 group-hover:translate-x-0.5 group-hover:bg-white/14 group-active:translate-x-0">
              <ArrowRight className="h-3.5 w-3.5 text-white transition duration-300 group-hover:translate-x-[1px]" strokeWidth={2.25} />
            </span>
          </button>
        </div>
      </div>
