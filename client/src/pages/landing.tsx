        ...
        <div className="container-page pt-4 sm:pt-6">
          <div className="pt-[104px] sm:pt-[112px] lg:pt-[132px]">
            <div className="max-w-[520px] lg:max-w-[640px]">
              ...
              >
                Energia limpa, acessível e renovável — assuma o controle da sua
                conta de luz com uma solução inteligente.
              </p>
              ...
              <div className="flex w-full max-w-[360px] items-center justify-between gap-3 rounded-[22px] bg-white/10 p-3 ring-1 ring-white/16 backdrop-blur md:max-w-[420px] lg:max-w-[520px]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    >
                      Nossos painéis mais vendidos unem durabilidade e
        ...
        <div className="md:pl-10 lg:pl-0 lg:col-start-2">
          <div className="lg:ml-auto lg:max-w-[740px]">
            ...
            <p
              ...
              className="mt-4 w-full text-sm leading-6 text-zinc-500"
            >
              ...
              soluções solares inteligentes, confiáveis e acessíveis
              <br />
              feitas para durar.
            </p>
          </div>
...
function ServiceCard({
  ...
  const text = (
    <div className="mt-4">
      ...
      <div
        data-testid={`text-service-sub-${service.id}`}
...
function ProductGrid({ services }: { services: Service[] }) {
  const topRow = services.slice(0, 3);
  const bottomRow = services.slice(3, 7);

  return (
    <section className="container-page pb-12 sm:pb-16 lg:pb-20">
      <div className="grid gap-6 lg:grid-cols-[420px_1fr] lg:gap-12">
        <div className="pt-1">
          <Pill testId="pill-our-product">( nosso produto )</Pill>
          <h3
            data-testid="text-grid-title"
            className="mt-4 text-balance text-[44px] font-medium leading-[1.04] tracking-[-0.03em] lg:text-[54px]"
          >
            Nossos serviços para um
            <br />
            <span className="text-zinc-400">futuro mais sustentável</span>
          </h3>
          <p
            data-testid="text-grid-desc"
            className="mt-4 max-w-[46ch] text-sm leading-6 text-zinc-500"
          >
            Da consultoria à manutenção, entregamos soluções completas com a mesma
            estética limpa e moderna — prontas para escalar.
          </p>
          <div className="mt-7">
            <button
        ...
        <div>
          <div className="grid gap-6 md:grid-cols-3">
            {topRow.map((s) => (
              <ServiceCard key={s.id} service={s} imagePosition="top" />
            ))}
          </div>

          <div className="mt-8 grid gap-6 md:grid-cols-4">
            {bottomRow.map((s) => (
              <ServiceCard key={s.id} service={s} imagePosition="bottom" />
            ))}
          </div>
        </div>
      </div>
        ...
        <div className="grid gap-10 p-8 md:grid-cols-[280px_1fr] md:items-center md:gap-12 md:p-10">
          ...
          <div>
            ...
            >
              ...
              <br />
              <span className="text-white/65">Energia limpa e confiável</span>
               feita
              <br />
    ...
    () => [
      {
        ...
        subtitle: "Projeto completo e instalação rápida",
        image: service1,
      },
      {
        id: "svc-2",
        title: "Baterias e armazenamento",
        subtitle: "Mais autonomia e estabilidade",
        image: service2,
      },
      {
        id: "svc-3",
        title: "Infraestrutura de recarga",
        subtitle: "Carregadores para veículos elétricos",
        image: service3,
      },
      {
        id: "svc-4",
        title: "Soluções comerciais",
        subtitle: "Escalável para empresas",
        image: service4,
      },
      {
        id: "svc-5",
        title: "Manutenção e limpeza",
        subtitle: "Performance sempre no máximo",
        image: service5,
      },
      {
        id: "svc-6",
        title: "Consultoria energética",
        subtitle: "Planejamento e dimensionamento",
        image: service6,
      },
      {
        id: "svc-7",
        title: "Monitoramento inteligente",
        subtitle: "Acompanhe a geração em tempo real",
        image: service7,
      },
    ],
    [],
