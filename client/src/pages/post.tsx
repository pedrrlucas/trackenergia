...
export default function PostPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <main>
        {/* Article Header */}
        <article className="container-page max-w-[960px] mx-auto pb-16 lg:pb-24 pt-8 lg:pt-12">
          <header className="flex flex-col gap-6 mb-12 lg:mb-16">
            
            <Link href="/" className="group inline-flex items-center gap-2 text-sm font-medium text-zinc-500 transition-colors hover:text-[#1d0238] mb-4">
