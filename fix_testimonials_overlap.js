  ...
  return (
    ...
    >
      <div className="grid gap-10 lg:grid-cols-[380px_minmax(0,1fr)] xl:grid-cols-[420px_minmax(0,1fr)] lg:gap-14 items-center">
        ...
        >
          {/* overflow-hidden para não sobrepor o texto na esquerda */}
            ...
            <div className="flex touch-pan-y gap-6 py-4 px-2" style={{ backfaceVisibility: 'hidden' }}>
              {items.map((t, index) => {
                ...
                return (
                  ...
                  >
                    <div className={\`flex flex-col h-full rounded-[32px] p-6 sm:p-8 transition-all duration-500 \${isActive ? 'bg-white shadow-xl shadow-black/5 ring-1 ring-zinc-200 scale-100 opacity-100' : 'bg-zinc-50 ring-1 ring-zinc-100 scale-[0.96] opacity-60 hover:opacity-100'}\`}>
          ...
          {/* Navegação Manual */}
          <div className="mt-6 flex items-center gap-2 pl-2 relative z-30">
            <button
              onClick={scrollPrev}
              className="pointer-events-auto grid h-10 w-10 place-items-center rounded-full bg-white shadow-sm ring-1 ring-zinc-200 text-zinc-600 transition hover:bg-zinc-50 hover:text-zinc-900 active:scale-[0.98]"
              aria-label="Anterior"
            >
...
console.log("Fixed Testimonials overlap issue.");
