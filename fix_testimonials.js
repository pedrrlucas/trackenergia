          ...
          <div className="overflow-visible" ref={emblaRef}>
            <div className="flex touch-pan-y gap-6 sm:gap-8 py-4 px-2" style={{ backfaceVisibility: 'hidden' }}>
              {items.map((t, index) => (
                ...
                >
                  <div className={\`flex flex-col h-full rounded-[32px] p-6 sm:p-8 transition-all duration-500 \${selectedIndex === index ? 'bg-white shadow-xl shadow-black/5 ring-1 ring-zinc-200 scale-100 z-10' : 'bg-zinc-50 ring-1 ring-zinc-100 scale-[0.98] opacity-60 hover:opacity-100 z-0'}\`}>
